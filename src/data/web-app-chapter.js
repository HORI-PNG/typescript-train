...
const record: StudyRecord = {
  ...
  memo: "ユニオン型を復習する"
        ...
        challenge: "Book型を作ってください。titleとauthorは必須の文字列、finishedAtは任意の文字列にします。",
    },
    {
        id: "dom-events",
...
if (input instanceof HTMLTextAreaElement) {
  ...
  if (target instanceof HTMLButtonElement) {
    console.log(target.dataset.lessonId);
        ...
        challenge: "idが「title」のinputを取得し、存在しない場合にはエラーを出すコードを書いてください。",
    },
    {
        id: "state-render",
        title: "状態と表示を分ける",
...
let state: AppState = {
  ...
  app.innerHTML = \`完了数: \${state.completedLessonIds.length}\`;
        ...
        challenge: "selectedLessonIdを受け取り、stateだけを更新するselectLesson関数を書いてください。",
    },
    {
        id: "storage",
...
async function fetchLessons(): Promise<LessonSummary[]> {
  ...
  return response.json() as Promise<LessonSummary[]>;
        ...
        challenge: "fetch関数の失敗時に、HTTPステータスを含むErrorを投げるように変更してください。",
    },
];
