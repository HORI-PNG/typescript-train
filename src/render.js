...
export function render(options) {
    ...
    const selectedLesson = options.lessons.find((lesson) => lesson.id === options.selectedLessonId);
...
function attachListEvents(app, options) {
    app
...
function attachLessonEvents(app, lesson, options) {
